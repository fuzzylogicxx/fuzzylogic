...
<main>
	...
	<h2>Web</h2>
	<p>I’ve been working as a web developer since 2003. The web inspired me then (as it still does now) firstly because a single person can create and publish something that becomes instantly available around the world; and secondly because of the guiding principle that it should be an information-sharing resource <em>accessible to all</em>.</p>
