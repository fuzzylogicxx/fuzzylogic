...
description: "A nice explanation of why we should approach UI for dates the user knows differently from dates the user will choose"
tags: [link, a11y, input, forms, html, ux]
noteWithTitle: false
